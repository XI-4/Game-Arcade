...
player_ship = 'karcwe1.png'
enemy_ship = 'karcwo1.png'
ufo_ship = 'k3.png'
player_bullet = 'bp.png'
enemy_bullet = 'be.png'
ufo_bullet = 't2.png'
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        if self.alive:
            ...
            self.alpha_duration = 0
            hth_x = self.rect.x + 20
            hth_y = self.rect.y + 40
            explosion = Explosion(hth_x, hth_y)
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.img_list = []
        for i in range(1, 6):
            img = pygame.image.load(f'hth{i}.png').convert()
...
class Game:
    ...
    def start_text(self):
        ...
        text = font.render('SPACE WAR', True, 'black')
