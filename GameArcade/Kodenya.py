...
new_dir = "/brbbbbbbbbbbb/Kode/Python/GameArcade"  
try:
    os.chdir(new_dir)
...
ufo_bullet = 'mufobullet.png'
 
 
''' SOUND '''
 
laser_sound = pygame.mixer.Sound('fart.wav')
explosion_sound = pygame.mixer.Sound('fart.wav')
go_sound = pygame.mixer.Sound('fart.wav')
game_over_sound = pygame.mixer.Sound('fart.wav')
start_screen_music = pygame.mixer.Sound('cyberfunk.mp3')
game_over_music = pygame.mixer.Sound('cyberfunk.mp3')
 
background_music = pygame.mixer.music.load('cyberfunk.mp3')
